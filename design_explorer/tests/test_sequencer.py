...
class testSequencer(unittest.TestCase):
    ...
    def test_edge_and_trace_diagram_creation_with_boxes_2(self):
        ...
        oNodeList.add_node(graph.node('N6', 'F2'))
        oNodeList.add_node(graph.node('N7'))
        oNodeList.add_node(graph.node('N8', 'F2'))
        oNodeList.add_node(graph.node('N9', 'F1'))
        oNodeList.add_node(graph.node('N10', 'F3'))
        oTrace = graph.trace()
        oTrace.add_to_path(graph.edge('N1', 'N2', 'E1'))
        oTrace.add_to_path(graph.edge('N2', 'N3', 'E2'))
        oTrace1 = graph.trace()
        ...
        oTrace1.add_to_path(graph.edge('N5', 'N6', 'E5'))
        oTrace1.add_to_path(graph.edge('N6', 'N7', 'E6'))
        oTrace1.add_to_path(graph.edge('N7', 'N8', 'E7'))
        oTrace1.add_to_path(graph.edge('N8', 'N9', 'E8'))
        oTrace1.add_to_path(graph.edge('N9', 'N10', 'E9'))
        oTrace1.add_to_path(graph.edge('N9', 'N10', 'E9'))
        oTrace1.add_to_path(graph.edge('N9', 'N10', 'E9'))
        ...
        dExpected.append('N5 -> N6 : E5')
        dExpected.append('N6 -> N7 : E6')
        dExpected.append('N7 -> N8 : E7')
        dExpected.append('N8 -> N9 : E8')
        dExpected.append('N9 -> N10 : E9')
        dExpected.append('N9 -> N10 : E9')
        dExpected.append('N9 -> N10 : E9')
        dExpected.append('')
        dExpected.append('@enduml')
