...
oAnode.add_port(de.port.create('Anode', 10, 'in', 'The end that is driven by the user'))

# This is the ground node
oCathode = de.interface.create('Cathode')
oCathode.add_port(de.port.create('Cathode', 10, 'in', 'The end that is driven to ground'))
